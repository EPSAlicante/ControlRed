...
//    var $default_ttfont = 'benjamingothic.ttf';
    var $ttf_path = './includes/fuentesttf/';                    // Default path to look in for TT Fonts.
    var $default_ttfont = 'arial.ttf';
...
//Colors and styles       (all colors can be array (R,G,B) or named color)
    ...
    var $data_colors = array('SkyBlue', 'green', 'orange', 'blue', 'salmon', 'red', 'violet', 'azure1','magenta','yellow');
    ...
    var $point_sizes = 5;         // single value or array
